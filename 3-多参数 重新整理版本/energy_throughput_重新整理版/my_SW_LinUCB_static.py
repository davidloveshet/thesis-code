...
# we decide to write a new function to compare with the previous version
class my_SW_LinUCB_comparison(object):
    ...
    def compute_index(self, hat_theta, feature, invcov, t_slot):
...
# theta_b = np.array([ [0.3], [0.4], [0.8], [0.2]])
# theta_a = theta_b.reshape(4,)

# feature_b = np.array([ [0.13],[0.44],[0.23],[0.87]  ])
# feature_a = feature_b.reshape(4,)
# dimension = 4
# lambdada = 0.11

# a = my_SW_LinUCB_static(theta_a, feature_a, dimension, lambdada)
# b = my_SW_LinUCB_comparison(theta_b, feature_b, dimension, lambdada)
# for t in range(10):
#     reward = np.random.normal(0.7,0.3)
#     a.update_information(feature_a, reward)
#     print(a.hat_theta)
#     print("the reward is", a.obtain_reward(feature_a, theta_a))
#     b.update_information(feature_b, reward) 
#     print(b.hat_theta)
#     print("the reward is", b.obtain_reward(feature_b, theta_b))
#     a.compute_index(a.hat_theta, 0.1, 1, feature_a, a.invcov)
#     print("the index is", a.ucb_s)
#     b.compute_index(b.hat_theta, 0.1, 1, feature_b, b.invcov)
#     print("the index is", b.ucb_s)
