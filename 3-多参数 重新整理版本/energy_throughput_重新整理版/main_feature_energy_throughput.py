...
TRAFFIC_TYPE = '1' # '2' 表示不同的 QoS 要求

仿真结果记录在文件'plot_algorithm_single_user_energy_throughput.py'中
...
ALGO = 'proposed' # 不同算法 'fixed' 'random' 'proposed'
...
# 将 Throuhgput_y_label 和 Energy_cost_y_label 记录在 'plot_algorithm_single_user_energy_throughput.py' 中 
