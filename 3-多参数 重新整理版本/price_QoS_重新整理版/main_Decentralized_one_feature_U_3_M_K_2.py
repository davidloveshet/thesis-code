...
TRAFFIC_TYPE = '1', '2'. Choose different value of this variable, we can obtain various QoS requirement
        ...
        if t < T_init: # initialization, each channel has been sensed
            ...
            if collision_set_1_2 != []:
                ...
                for i in range(len(collision_set_1_3)):
                    ...
                    collision_Num[m_c][t] += 1
                    Throughput_mc_3[m_c][t] = Throughput_mc_3[m_c][t] - channel_state[collision_set_1_3[i]] # theta_generation_1[collision_set_1_3[i]][0]
