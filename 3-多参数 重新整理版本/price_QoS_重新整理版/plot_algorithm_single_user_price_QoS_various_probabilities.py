...
# cumulative_utility_regret_y_label_M_3 = np.array([ 70.8       ,  91.26666667, 131.33333333, 177.26666667,
#        208.53333333, 236.06666667, 256.26666667, 263.        ,
#        266.2       , 272.2       , 291.        , 294.46666667]) 

# cumulative_utility_regret_y_label_M_2 = np.array([ 61.4       ,  82.6       , 128.06666667, 178.8       ,
#        208.53333333, 244.2       , 259.53333333, 277.93333333,
#        298.33333333, 318.66666667, 328.        , 344.13333333])

# cumulative_utility_regret_y_label_M_1 = np.array([ 36.00685625,  52.0444125 ,  87.69975   , 142.88355625,
#        189.87384375, 225.67503125, 264.11570625, 295.123475  ,
#        319.66629375, 340.6493125 , 365.15269375, 378.22120625])
...
# # plt.plot(regret_x_label, cumulative_utility_regret_y_label_M_3_K_1,'--o', label = 'M=3,K=1' )
# # plt.plot(regret_x_label, cumulative_utility_regret_y_label_M_3_K_2,'--.', label = 'M=3,K=2' )
# plt.plot(regret_x_label, cumulative_utility_regret_y_label_M_1,'--^', label = 'M=1' )
# plt.plot(regret_x_label, cumulative_utility_regret_y_label_M_2,'--^', label = 'M=2' )
# plt.plot(regret_x_label, cumulative_utility_regret_y_label_M_3,'--^', label = 'M=3' )
# plt.legend(ncol=1,framealpha = 0,fontsize=12)
# plt.xlabel('time',fontsize=16)
# plt.ylabel('utility loss',fontsize=16)
# plt.title('s=2',fontsize=16)
# # plt.ylim([10,360])
# plt.grid()
# fig.savefig('s_1_regret.eps', dpi = 600, format = 'eps')
...
# cumulative_utility_regret_y_label_M_3 = np.array([ 65.34487875,  92.50105425, 147.76799025, 203.02431975,
#        251.600322  , 291.76536975, 327.66483675, 346.96513125,
#        370.230489  , 392.0975565 , 393.34382025, 405.14885475])

# cumulative_utility_regret_y_label_M_2 = np.array([ 59.085276  ,  84.936852  , 140.61920925, 221.77661175,
#        269.4864165 , 308.493588  , 341.59824225, 374.29808175,
#        404.00688825, 424.53046575, 446.653857  , 458.73289275]) 

# cumulative_utility_regret_y_label_M_1 = np.array([ 38.96651325,  58.5019185 , 102.9007275 , 175.18225725,
#        220.091946  , 255.4929075 , 291.62394975, 327.3873    ,
#        364.11937725, 388.424172  , 411.84509175, 426.3989775 ]) 
