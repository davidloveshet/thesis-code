...
# write a new class to compare with the previous version, addin the sliding window function.
...
# In[1] the following functions are for the dynamic environments, using sliding window techniques. Not RELATED to this work but for the subsequent research        
