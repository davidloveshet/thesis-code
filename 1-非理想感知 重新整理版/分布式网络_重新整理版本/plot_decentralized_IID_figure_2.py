...
# fig.savefig('decentralized_IID_figure_2_regret.eps', dpi = 600, format = 'eps')
...
plt.plot(x_Num,N_20_U_3_M_4_K_2_reward,'-', label = 'N=20,U=3,M=4,K=2', LineWidth = 2)
...
plt.plot(x_Num,N_20_U_3_M_4_K_2_reward_optimal,'--', label = 'N=20,U=3,M=4,K=2,optimal', LineWidth = 2)
...
# fig.savefig('decentralized_IID_figure_2_reward.eps', dpi = 600, format = 'eps')
