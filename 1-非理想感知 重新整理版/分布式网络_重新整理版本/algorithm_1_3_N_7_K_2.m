...
Collisions_Num = 0;
Collisions_Num_1_2 = 0;
Collisions_Num_1_3 = 0;
Collisions_Num_2_3 = 0;
...
%         channel_chosen_access_3 = zeros(1,K);
        ...
        if length(check_1_2) > 0
            u_1 = randi(3);
            u_2 = randi(3);
            Collisions_Num_1_2 = Collisions_Num_1_2 + 1;
        end
        ...
        if length(check_1_3) > 0
            u_1= randi(3);
            u_3 = randi(3);
            Collisions_Num_1_3 = Collisions_Num_1_3 + 1;
        end
        ...
        if length(check_2_3) > 0
            u_2 = randi(3);
            u_3 = randi(3);
            Collisions_Num_2_3 = Collisions_Num_2_3 + 1;
        end
        
        Collisions_Num = Collisions_Num_1_2 + Collisions_Num_1_3 + Collisions_Num_2_3;
...
% save 'N_7_U_2_M_2_K_2_regret.mat' save_result2
% save 'N_7_U_2_M_2_K_2_reward.mat' save_result1
% save 'N_7_U_2_M_2_K_2_reward_optimal.mat' Reward_expect_all
