...
channel_free_prob = [0.1647 0.7506 0.4402 0.9408 0.8242 0.6610]'; 
...
% Reward_expect_all = ( 1.1587 + 1.1154) * (1-P_fa);
Reward_expect_all = (1-P_fa) * sum(channel_free_prob(1:4));
...
% save 'N_6_U_2_M_2_K_2_regret.mat' save_result2
% save 'N_6_U_2_M_2_K_2_reward.mat' save_result1
% save 'N_6_U_2_M_2_K_2_reward_optimal.mat' Reward_expect_all
