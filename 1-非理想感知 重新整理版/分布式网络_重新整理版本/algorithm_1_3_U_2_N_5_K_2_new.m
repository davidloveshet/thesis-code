...
K = 2; % 表示接入信道数量
num = 1;
sample_num_Zhou_Zhang_N_20_K_2 = sample_num_iter;
...
% 
% 
% sample_num_Zhou_Zhang_N_20_K_2 = [ 1000 5000 10000 50000 80000 120000 150000 ];
% Regret_log_Zhou_Zhang_N_20_K_2 = [  121 320  439.943 764.817 873.134670 957.996011 1010.16 ];
% figure
% plot(sample_num_Zhou_Zhang_N_20_K_2,Regret_log_Zhou_Zhang_N_20_K_2,'bo-','LineWidth',2)
