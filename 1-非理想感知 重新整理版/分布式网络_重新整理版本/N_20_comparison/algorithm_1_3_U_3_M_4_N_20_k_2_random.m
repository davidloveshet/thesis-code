...
%         M_sensed_channels_3 = sequence_3(1:M);    
        ...
        %% Fixed channel allocation 固定信道分配策略
 
        M_sensed_channels_1 = sequence_1( 1:M );
        M_sensed_channels_2 = sequence_2( M+1:2*M );
        M_sensed_channels_3 = sequence_3( 2*M+1:3*M );
...
% save 'N_20_U_3_M_4_K_2_regret_random.mat' save_result2
% save 'N_20_U_3_M_4_K_2_reward_random.mat' save_result1
