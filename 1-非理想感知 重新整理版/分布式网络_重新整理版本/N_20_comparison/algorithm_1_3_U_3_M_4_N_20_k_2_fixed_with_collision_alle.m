...
%     estimated_prob_user_3 = channel_free_prob;
    ...
    for t = 2:sample_num
        ...
        M_sensed_channels_1 = sequence_1( (u_1-1)*M+1 : u_1 * M );       
        M_sensed_channels_2 = sequence_2( (u_2-1)*M+1 : u_2 * M );      
        M_sensed_channels_3 = sequence_3( (u_3-1)*M+1 : u_3 * M );
...
% save 'N_20_U_3_M_4_K_2_regret_fixed_colli_alle.mat' save_result2
% save 'N_20_U_3_M_4_K_2_reward_fixed_colli_alle.mat' save_result1
