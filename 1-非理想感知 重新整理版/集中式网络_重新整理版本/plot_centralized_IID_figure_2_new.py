...
P_d_07_P_f_03_regret = scipy.io.loadmat('P_d_07_P_f_03_regret.mat')['Regret_as_time'][0]
...
plt.plot(x_Num,P_d_07_P_f_03_regret,'-', label = '$P_d=0.7$,$P_f=0.3$', LineWidth = 2)
...
P_d_07_P_f_03_reward = scipy.io.loadmat('P_d_07_P_f_03_reward.mat')['Reward_average_as_time'][0]
...
P_d_07_P_f_03_reward_optimal = scipy.io.loadmat('P_d_07_P_f_03_reward_optimal.mat')['Reward_expect_all_status'][0] * np.ones(Sample_Num)
...
plt.plot(x_Num,P_d_07_P_f_03_reward,'-', label = '$P_d=0.7$,$P_f=0.3$', LineWidth = 2)
...
plt.plot(x_Num,P_d_07_P_f_03_reward_optimal,'--', label = '$P_d=0.7$,$P_f=0.3$,optimal')
plt.plot(x_Num,P_d_08_P_f_03_reward_optimal,'--', label = '$P_d=0.8$,$P_f=0.3$,optimal')
plt.plot(x_Num,P_d_08_P_f_01_reward_optimal,'--', label = '$P_d=0.8$,$P_f=0.1$,optimal')
plt.plot(x_Num,P_d_08_P_f_02_reward_optimal,'--', label = '$P_d=0.8$,$P_f=0.2$.optimal')
