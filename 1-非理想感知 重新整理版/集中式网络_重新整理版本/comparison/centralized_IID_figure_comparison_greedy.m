...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description : This is used to simulate the centralized algorithm in Chap 3.2: Figure 3.9 and Figure 3.10
%               
%               Author: xxx
%               Date  : 2018/03/22
%               Modified : 2023/05/01
...
% save 'P_d_greedy_regret.mat' Regret_as_time
% save 'P_d_greedy_reward.mat' Reward_average_as_time
% save 'P_d_greedy_reward_optimal.mat' Reward_expect_all_status
